...
| [components/qdrant-segments-and-hnsw.md](components/qdrant-segments-and-hnsw.md) | Qdrant segments, per-segment HNSW graphs, storage tiers (mmap, on_disk, quantized-in-RAM), ZFS ARC/L2ARC interaction, measurements from the DTIC load, the consolidation plan and operating rules. |
