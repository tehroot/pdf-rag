...
import org.example.backend.qdrant.ChunkPipeline;
import org.example.backend.qdrant.Chunker;
...
import org.example.backend.qdrant.fusion.ConfidenceCalculator;
import org.example.backend.qdrant.fusion.FusionEngine;
import org.example.backend.qdrant.fusion.FusionStrategy;
import org.example.backend.qdrant.fusion.RrfFusion;
...
class QdrantBackendTest {
    ...
    void ingest_modeMismatch_existingVisualKb_throws() throws Exception {
        ...
        try {
            ...
            org.assertj.core.api.Assertions.assertThatThrownBy(() -> visualBackend.ingest(req))
                    .isInstanceOf(org.example.ingest.IngestException.class)
    ...
    private static QdrantBackend newBackendWithVisual(String baseUrl, java.nio.file.Path tmpRoot) throws Exception {
        ...
        org.example.backend.qdrant.ColPaliClient sidecar = new org.example.backend.qdrant.ColPaliClient();
        ...
        org.example.backend.qdrant.FilesystemPageImageStore store =
                new org.example.backend.qdrant.FilesystemPageImageStore();
